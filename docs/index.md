...
Here, you can find documentation on all three parts. More information about the architecture of MesoNet and the dataset used for training is available in the [README](https://github.com/MalayAgarwal-Lee/MesoNet-DeepFakeDetection#22-the-model) of Part 1.
