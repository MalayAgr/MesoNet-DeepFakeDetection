...
In reality, thought, it may be the case that the user does NOT achieve the claimed accuracy in the paper. This could be because of the size of the dataset, which has potentially too many images in the test set.
...
Alternatively, the user can use any dataset of their choice as long as the directory structure matches the one above.
